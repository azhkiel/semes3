...
Public Class FormBelanja
    ...
    Private Sub btnBayarPesanan_Click(sender As Object, e As EventArgs) Handles btnBayarPesanan.Click
        ...
        For Each item As ListViewItem In ListViewPesanan.Items
            ...
            If SimpanOrder(CustomerName, namaMenu, kategori, jumlah, totalHarga, nomorAntrian) Then
        ...
        Dim nota As String = $"========= NOTA PEMBAYARAN ========={Environment.NewLine}" &
                         ...
                         $"Nama Customer: {CustomerName}{Environment.NewLine}" &
    ...
    Public Function SimpanOrder(CustomerName As String, namaMenu As String, kategori As String, jumlah As Integer, totalharga As Decimal, nomorAntrian As String) As Boolean
        Try
            ' Pastikan koneksi database sudah benar
            Using conn As MySqlConnection = GetKoneksi()
                ' Query SQL untuk memasukkan data pesanan
                Dim cmd As New MySqlCommand("INSERT INTO `order` (`username`, `nama_Menu`, `kategori`, `jumlah`, `harga_total`, `waktu`, no_antrian) VALUES (@customerName, @namaMenu, @kategori, @jumlah, @totalHarga, @purchaseDate, @antrian)", conn)
